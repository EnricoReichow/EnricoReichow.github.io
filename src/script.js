...
const normalTexture = textureLoader.load('/texture/CirclesNormalMap.png')
...
const geometry = new THREE.SphereBufferGeometry(.5, 60, 60)
...
//light 3
const pointLight3 = new THREE.PointLight(0xff00ff, 0.1) 
pointLight3.position.set(3,-5.1,-3)
pointLight3.intensity = 6.5
...
const tick = () =>
{
    ...
    sphere.rotation.z += .05 * (targetX - sphere.rotation.z)
